...
[![R-universe
version](https://p-emex.r-universe.dev/mrgsim.ds/badges/version)](https://p-emex.r-universe.dev/mrgsim.ds)
[![r-universe
status](https://p-emex.r-universe.dev/mrgsim.ds/badges/checks)](https://p-emex.r-universe.dev/mrgsim.ds)
...
. Owner: yes (gc)
.     ID time        CL     IPRED
. 1:   1  0.0 0.7113651 0.0000000
. 2:   1  0.0 0.7113651 0.0000000
. 3:   1  0.5 0.7113651 0.6765573
. 4:   1  1.0 0.7113651 1.2380828
. 5:   1  1.5 0.7113651 1.7025064
. 6:   1  2.0 0.7113651 2.0849863
. 7:   1  2.5 0.7113651 2.3983372
. 8:   1  3.0 0.7113651 2.6533922
```
...
``` r
basename(out$files)
. [1] "mrgsims-ds-d6833c771dfc.parquet"
```
...
.      ID  time    CL IPRED
.   <dbl> <dbl> <dbl> <dbl>
. 1  3000  238. 0.632 0.899
. 2  3000  238  0.632 0.891
. 3  3000  238. 0.632 0.883
. 4  3000  239  0.632 0.875
. 5  3000  240. 0.632 0.867
. 6  3000  240  0.632 0.859
...
. Owner: yes (gc)
.     ID time       CL    IPRED
. 1:   1  0.0 1.668907 0.000000
. 2:   1  0.0 1.668907 0.000000
. 3:   1  0.5 1.668907 1.389168
. 4:   1  1.0 1.668907 2.164311
. 5:   1  1.5 1.668907 2.580709
. 6:   1  2.0 1.668907 2.787935
. 7:   1  2.5 1.668907 2.873612
. 8:   1  3.0 1.668907 2.889060
```
...
list_temp()
. 11 files [145 Mb]
. - mrgsims-ds-d6833c771dfc.parquet
. - mrgsims-ds-d6ca42ea1ca.parquet
.    ...
. - mrgsims-ds-d6ce5c630542.parquet
. - mrgsims-ds-d6ce754e2128.parquet
```
...
. Ncells 2142581 114.5    3811248 203.6         NA  3630808 194.0
. Vcells 3931312  30.0   16570059 126.5      16384 22218633 169.6
...
. Owner: no
.     ID TIME        CL    IPRED
. 1:   1  0.0 0.5679588 0.000000
. 2:   1  0.0 0.5679588 0.000000
. 3:   1  0.5 0.5679588 1.062482
. 4:   1  1.0 0.5679588 1.878848
. 5:   1  1.5 0.5679588 2.502902
. 6:   1  2.0 0.5679588 2.976728
. 7:   1  2.5 0.5679588 3.333242
. 8:   1  3.0 0.5679588 3.598189
