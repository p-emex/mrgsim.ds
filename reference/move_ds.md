...
out$files
#> [1] "/tmp/RtmpQ5UTLf/mrgsims-ds-new-name-1.parquet"
#> [2] "/tmp/RtmpQ5UTLf/mrgsims-ds-new-name-2.parquet"
#> [3] "/tmp/RtmpQ5UTLf/mrgsims-ds-new-name-3.parquet"

out <- combine_ds(out)

out$files
#> [1] "/tmp/RtmpQ5UTLf/mrgsims-ds-1a0d18c5a4fb.parquet"
```
