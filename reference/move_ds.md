...
out$files
#> [1] "/tmp/RtmpU5ISNK/mrgsims-ds-new-name-1.parquet"
#> [2] "/tmp/RtmpU5ISNK/mrgsims-ds-new-name-2.parquet"
#> [3] "/tmp/RtmpU5ISNK/mrgsims-ds-new-name-3.parquet"

out <- combine_ds(out)

out$files
#> [1] "/tmp/RtmpU5ISNK/mrgsims-ds-19b7588e0bb5.parquet"
```
