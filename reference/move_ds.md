...
out$files
#> [1] "/tmp/RtmppiMhWj/mrgsims-ds-new-name-1.parquet"
#> [2] "/tmp/RtmppiMhWj/mrgsims-ds-new-name-2.parquet"
#> [3] "/tmp/RtmppiMhWj/mrgsims-ds-new-name-3.parquet"

out <- combine_ds(out)

out$files
#> [1] "/tmp/RtmppiMhWj/mrgsims-ds-19c41614fb6b.parquet"
```
