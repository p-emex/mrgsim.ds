...
out$files
#> [1] "/tmp/Rtmpq8Zae2/mrgsims-ds-new-name-1.parquet"
#> [2] "/tmp/Rtmpq8Zae2/mrgsims-ds-new-name-2.parquet"
#> [3] "/tmp/Rtmpq8Zae2/mrgsims-ds-new-name-3.parquet"

out <- combine_ds(out)

out$files
#> [1] "/tmp/Rtmpq8Zae2/mrgsims-ds-1a5c41ff417c.parquet"
```
