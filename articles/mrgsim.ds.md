...
```
    ...
    ## 10 files [2.9 Mb]
    ## - mrgsims-ds-1c5c16954801.parquet
    ## - mrgsims-ds-1c5c1da60656.parquet
    ##    ...
    ## - mrgsims-ds-1c5c5f4f6393.parquet
    ## - mrgsims-ds-1c5cd05b70d.parquet
...
```
    ...
    ## ℹ 10 files are now located in /tmp/RtmpcjqprA; gc is off.
