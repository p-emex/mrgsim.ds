...
```
    ...
    ## 10 files [2.9 Mb]
    ## - mrgsims-ds-1c5520179cf6.parquet
    ## - mrgsims-ds-1c5530c7c36f.parquet
    ##    ...
    ## - mrgsims-ds-1c5576a85edc.parquet
    ## - mrgsims-ds-1c5596648b3.parquet
...
```
    ...
    ## ℹ 10 files are now located in /tmp/RtmpWZPQMX; gc is off.
