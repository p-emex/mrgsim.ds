...
```
    ...
    ## 10 files [2.9 Mb]
    ## - mrgsims-ds-1c5317565c49.parquet
    ## - mrgsims-ds-1c5327fc5d11.parquet
    ##    ...
    ## - mrgsims-ds-1c537bdd9b55.parquet
    ## - mrgsims-ds-1c537dcd421c.parquet
...
```
    ...
    ## ℹ files are now located in /tmp/Rtmpb3cBJr; gc is off.
